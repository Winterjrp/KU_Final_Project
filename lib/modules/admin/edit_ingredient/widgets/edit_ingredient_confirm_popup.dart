...
class EditIngredientConfirmPopup extends StatelessWidget {
  const EditIngredientConfirmPopup({
    ...
    return AlertDialog(
      ...
      content: const SizedBox(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 20),
            Center(
              child: Text('ยืนยันการแก้ไขข้อมูลวัตถุดิบ'),
            ),
          ],
        ),
      ),
      ...
      actions: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () async {
              viewModel.onUserEditIngredient(
