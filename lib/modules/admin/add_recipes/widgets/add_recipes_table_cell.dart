...
// typedef OnShowDropdownCallback = void Function({required bool showDropdown});
// typedef OnUpdateDropdownPositionCallback = void Function(
...
class AddRecipesTableCell extends StatefulWidget {
  ...
  // final OnShowDropdownCallback onShowDropdownCallback;
  // final OnUpdateDropdownPositionCallback onUpdateDropdownPosition;
  ...
  const AddRecipesTableCell({
    ...
    // required this.onShowDropdownCallback,
    // required this.onUpdateDropdownPosition,
                    ...
                    title: Row(
                      children: [
                        Text(
                          ...
                          style:
                              const TextStyle(color: darkFlesh, fontSize: 17.5),
                        ),
                        const Spacer(),
                        const Icon(
                          Icons.pets,
    ...
    return CompositedTransformTarget(
      ...
      child: Container(
        ...
        child: MouseRegion(
          ...
          //           color: _ingredientController.text.isEmpty
          //               ? Colors.red
          //               : Colors.black,
          //           width: _ingredientController.text.isEmpty ? 1.2 : 1.8),
          //     ),
