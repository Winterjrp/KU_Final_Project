...
import 'package:untitled1/modules/admin/pet_type/utils/typedef.dart';
...
import 'package:untitled1/modules/admin/pet_type/pet_type_info/widgets/nutrient_limit_info_table_cell.dart';
...
class NutritionalRequirementBaseView extends StatefulWidget {
  final int index;
  ...
  NutritionalRequirementBaseView({
  ...
  @override
  NutritionalRequirementBaseViewState createState() =>
      NutritionalRequirementBaseViewState();
}

class NutritionalRequirementBaseViewState
    extends State<NutritionalRequirementBaseView> {
  ...
  //                   {required PetPhysiologicalModel petPhysiologicalData}) {
  //                 widget.onUserDeleteNutritionalRequirementCallback(
  //                     petPhysiologicalData: petPhysiologicalData);
  //               },
  //             ),
  ...
  Future<void> _handleDeletePetChronicDisease() async {
    ...
    try {
      widget.onUserDeleteNutritionalRequirementCallback(
          nutritionalRequirementData: widget.petPhysiologicalInfo);
  ...
  Text _routingGuide() {
    return const Text(
      "จัดการข้อมูลชนิดสัตว์เลี้ยง / เพิ่มข้อมูลชนิดสัตว์เลี้ยง / ข้อมูลความต้องการทางโภชนาการ",
