...
class PetChronicDiseaseInfoTableCell extends StatefulWidget {
  ...
  @override
  PetChronicDiseaseInfoTableCellState createState() =>
      PetChronicDiseaseInfoTableCellState();
}

class PetChronicDiseaseInfoTableCellState
    extends State<PetChronicDiseaseInfoTableCell> {
  ...
  Widget _tableBody() {
    return Expanded(
      child: ListView.builder(
        itemCount: widget.petChronicDisease.nutrientLimitInfo.length,
        itemBuilder: (context, index) {
          return NutrientLimitInfoTableCell(
              ...
              tableColumnWidth:
                  _petChronicDiseaseNutrientLimitInfoTableColumnWidth,
              nutrientLimitInfo:
                  widget.petChronicDisease.nutrientLimitInfo[index]);
        },
      ),
    );
  }
