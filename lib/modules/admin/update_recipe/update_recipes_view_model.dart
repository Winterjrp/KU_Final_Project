...
class AddRecipesViewModel {
  ...
  Future<UpdateRecipeModel> fetchData() async {
    List<Future<dynamic>> futures = [
      services.getPetTypeInfoData(),
      services.getIngredientListData(),
    ];
  ...
  Future<void> getData() async {
    (await updateRecipeData).petTypeList = await services.getPetTypeInfoData();
    (await updateRecipeData).ingredientList =
        await services.getIngredientListData();
  }
  ...
  Future<void> getPetTypeListData() async {
    petTypeListData = services.getPetTypeInfoData();
  ...
  void calculateNutrient() {
    ...
    secondaryFreshNutrient[13].amount =
    ...
    secondaryFreshNutrient[15].amount =
    ...
    secondaryFreshNutrient[24].amount =
    ...
    secondaryFreshNutrient[27].amount =
...
class UpdateRecipeModel {
  List<PetTypeInfoModel> petTypeList;
