...
import 'package:untitled1/modules/admin/admin_get_recipe/widgets/admin_ingredient_in_searched_recipe_table_cell.dart';
import 'package:untitled1/modules/admin/admin_get_recipe/widgets/admin_nutrient_in_searched_recipe_table_cell.dart';
      ...
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return AdminNutrientInSearchedRecipeTableCell(
              index: index,
  ...
  Widget _ingredientTableBody() {
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return AdminIngredientInSearchedRecipeTableCell(
            index: index,
